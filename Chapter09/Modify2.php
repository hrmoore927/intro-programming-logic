...
<body>
	...
	<?php
		...
		print ("<tr><td><strong>US Currency</strong></td>
				<td><strong>Canadian Currency</strong></td></tr>");

		for ($dollarsUS = 100; $dollarsUS <= 500; $dollarsUS = $dollarsUS + 50 )
		{
			$dollarsCanadian = $dollarsUS * 1.25;
			print("<tr><td align = \"center\">$dollarsUS</td>
				<td align = \"center\">$dollarsCanadian</td></tr>");
		}
